...
public class InvoiceService implements InvoiceServiceable {
    ...
    @Override
    public List<CustomerForm> getCustomerOrder(String name, Date date, List<String> stL ) throws Exception {
        List<CustomerForm> customerFormList = new ArrayList<CustomerForm>();
        List<Object[]> objList = null;
        try {
            objList = BASECustomerQuery.customerListQuery(em, name, date, stL);
